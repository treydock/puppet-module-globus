...
describe 'globus' do
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      it { is_expected.to contain_anchor('globus::start').that_comes_before('Class[epel]') }
      ...
      it { is_expected.to contain_class('globus::service').that_comes_before('Anchor[globus::end]') }
      it { is_expected.to contain_anchor('globus::end') }
